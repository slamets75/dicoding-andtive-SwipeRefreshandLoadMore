package dicodingac.app.swiperefreshandloadmore;
...
private LoadMoreListView lvItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);lvItem = (LoadMoreListView)findViewById(R.id.lv_item);
    ...
    private void populateDefaultData(){
        ...
        "Not Apple", "Not Blackberry","Cupcake", "Donut", "Eclair", "Froyo", "Gingerbread", "Honeycomb", "Ice cream sandwich", "Jelly Bean", "Kitkat", "Lollipop",
    ...
    //Background proses palsu untuk melakukan proses delay dan append data di bagian atas lis
